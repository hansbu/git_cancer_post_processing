...
til_thresholded = '/data01/shared/hanle/tumor_project/pub_tumor_cancer_brca/til_brca_vgg_mix_binary_heatmap_txt'
...
til_cancer_fol = '/data01/shared/hanle/tumor_project/pub_tumor_cancer_brca/heatmap_png/brca_cancer_til_pathDB_TILs-VGG'       # output folder
        ...
        for ind, til in enumerate(tils):
            ...
            if y - patch_h_half < 0 or y + patch_h_half >= iml_u.shape[0] or x - patch_w_half < 0 or x + patch_w_half >= iml_u.shape[1]:
                ...
                if window_sum <= window.shape[0]*window.shape[1]*delta:     # this is non-cancer patch
                    ...
                    res = 1
                    c_pos += 1
                else:                                                       # this is patch on the boundary, it still contains some cancer
                    res = 2
                    c_bou += 1
